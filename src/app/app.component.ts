...
import { CalculationData, CalculationResult, DataSet, RanksByDate, RanksDataSet, RelStrTableData, ResultsDataSet, StockData, StockDatum, StockRanks, StockResults } from './interfaces';
