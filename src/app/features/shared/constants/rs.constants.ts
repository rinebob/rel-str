...
import { RelStrStockList, RsSyncfusionChartConfig, RsChartConfig, Timeframe, MaConfig, MaType, MainMaId } from "../types/rs.interfaces";
...
export const DEFAULT_MAIN_MA_CONFIGS: MaConfig[] = [
    { id: MainMaId.MA1, enabled: true, type: MaType.EMA, length: 10, color: '#ffb300' },
    { id: MainMaId.MA2, enabled: true, type: MaType.EMA, length: 20, color: '#1e88e5' },
    { id: MainMaId.MA3, enabled: true, type: MaType.EMA, length: 50, color: '#8e24aa' },
];
