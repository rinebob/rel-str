...
import { CalculationData, CalculationResult, DataSet, RanksByDate, RelStrTableData, ResultsDataSet, StockData, StockDatum, StockResults } from '../../common/interfaces-rs';
import * as stockData from '../../data/stocks';
