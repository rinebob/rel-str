...
import { ChartModule, ChartComponent as SfChartComponent, CandleSeriesService, LineSeriesService, ColumnSeriesService, DateTimeService, TooltipService, LegendService, ZoomService, CrosshairService } from '@syncfusion/ej2-angular-charts';
...
import type { CandleWithRSColor, ChartAxisConfig, RsPaneDatum } from '../../common/interfaces-rs';
...
@Component({
	...
	standalone: true,
	imports: [CommonModule, ChartModule, RsPaneComponent, ChartToolbarComponent],
...
export class ChartViewComponent implements OnInit {
	...
	/**
	 * Signal for the main candle data array (MSFT, colored). Always initialized as an empty array.
	 */
	 ...
	 */
	/**
	 * Signal holding the visible candle data window for the current zoom. Always initialized as an empty array.
	 */
