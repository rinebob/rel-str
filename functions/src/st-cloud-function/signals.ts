...
/**
 * Signal history doc stored under savant-trader/data/symbol-meta/{SYMBOL}/signal-history/{date}.
...
/**
 * Run-id doc stored under savant-trader/data/symbol-meta/{SYMBOL}/run-ids/{runId}.
