# Cascade Communication Directive

When working with this user, proceed in measured steps.

- Stop after each meaningful action and give a concise status update.
- Explain what was done, what the current state is, and what the next step would be.
